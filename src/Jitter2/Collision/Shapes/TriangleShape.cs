...
public class TriangleShape : RigidBodyShape
{
    ...
    {
        ArgumentNullExceptionExt.ThrowIfNull(mesh, nameof(mesh));
        ArgumentOutOfRangeExceptionExt.ThrowIfNegative(index, nameof(index));
        ArgumentOutOfRangeExceptionExt.ThrowIfGreaterThanOrEqual(index, mesh.Indices.Length, nameof(index));
